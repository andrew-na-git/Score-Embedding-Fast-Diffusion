...
def create_report(folder_path):
    ...
    total_run_time = state["train_time"]
    ...
    samples = sample(model, config, ema_helper, sample_method, ground_truths=torch.from_numpy(ground_truths))
    ...
    pdf.cell(20)
    pdf.cell(10, 0, f"Model Type: Comparison")
    pdf.cell(80)
    ...
    pdf.cell(20)
    pdf.cell(10, 0, f"Sample method: {sample_method.upper()}")
    pdf.cell(80)
    pdf.cell(10, 0, f"Betas: {beta_min} to {beta_max}")
    pdf.ln(7)
